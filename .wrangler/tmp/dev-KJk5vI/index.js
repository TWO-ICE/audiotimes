...
// .wrangler/tmp/bundle-OmjOfT/checked-fetch.js
...
// .wrangler/tmp/bundle-OmjOfT/strip-cf-connecting-ip-header.js
  ...
  try {
    ...
    return new Response(JSON.stringify({
      ...
      data: {
        ...
        // 微秒格式的时长
        duration_rounded: durationRounded,
        // 向上取整到小数点后1位的时长（秒）
...
// .wrangler/tmp/bundle-OmjOfT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-OmjOfT/middleware-loader.entry.ts
